...
You can post/pay any invoice amount. Admin Officers can post customer invoices and vendor bills with no amount cap, cancel or reset invoices, and apply customer credit. Paying vendor bills stays Finance/Director.
