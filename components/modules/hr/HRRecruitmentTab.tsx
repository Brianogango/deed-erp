  ...
  return (
    <div className="flex flex-col">
      <div className="p-4 border-b border-[var(--border-lt)] flex items-center justify-between bg-[var(--bg-surface)]">
        ...
        {isAdmin && (
          <button onClick={openCreate} className="btn-primary py-1.5 px-4 text-10 flex items-center gap-2">
            <Fa icon={faPlus} />
                ...
                <div key={j.id} className="card p-4 flex items-center justify-between hover:border-primary-500/30 transition-all cursor-pointer group">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-10 text-[var(--text-4)] uppercase font-semibold tracking-wider">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <span className={`text-10 font-bold px-2 py-0.5 rounded-full ${j.status === 'open' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'}`}>
                        {j.status.toUpperCase()}
                      </span>
                      <p className="text-10 text-[var(--text-4)] mt-1">Posted {fmtDate(j.postedDate)}</p>
                    </div>
                  ...
                  candidates.map(c => {
                    ...
                    return (
                      <tr key={c.id} className="hover:bg-[var(--bg-surface)] transition-colors cursor-pointer">
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-10 text-[var(--text-4)]">{c.email}</p>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="px-4 py-3">
                          <span className="text-10 font-bold px-2 py-0.5 rounded-full bg-primary-50 text-primary-700 capitalize">
                            {c.stage}
                          </span>
                        </td>
