              ...
              {paymentConfirmed ? (
                <div style={{ padding: 16, borderRadius: 12, background: 'rgba(16,185,129,0.1)', border: '1px solid rgba(16,185,129,0.28)' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                    ...
                    <a href={`/api/portal/repair/${encodeURIComponent(ref)}/invoice-pdf`} download style={{ textAlign: 'center', padding: '12px 10px', borderRadius: 12, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.16)', color: '#E5E7EB', fontWeight: 800, fontSize: 12, textDecoration: 'none' }}>Download Invoice</a>
                  </div>
                </div>
