...
/** Canonical live codes — keep stable. Aligned to the official Deed CoA (2025). */
export const COA_ROLE_CODES: Record<CoaRole, string> = {
  ar: '1800',
  ap: '3000',
  output_vat: '3301',
  customer_deposits: '3100',
  customer_credits: '3313',
  inventory: '1200',
  cogs: '6001',
  grni: '3201',
  ...
  bank_equity: '2202',
  cash_mobile: '2211',
  employee_reimbursements: '3312',
  outstanding_receipts: '1933',
  outstanding_payments: '3202',
  input_vat: '1150',
  bank_charges: '6703',
  interest_income: '5201',
  salary_expense: '6601',
  employer_nssf_expense: '6606',
  employer_housing_levy_expense: '6609',
  net_payroll_payable: '3310',
  paye_payable: '3302',
  nssf_payable: '3303',
  shif_payable: '3304',
  housing_levy_payable: '3305',
  pension_payable: '3306',
  other_payroll_deductions: '3311',
  employee_advances: '1931',
}
...
export const COA_ROLE_LABELS: Record<CoaRole, string> = {
  ...
  customer_credits: '3313 - Customer Credits',
  ...
  employee_reimbursements: '3312 - Employee Reimbursements Payable',
  outstanding_receipts: '1933 - Outstanding Receipts',
  outstanding_payments: '3202 - Outstanding Payments',
  input_vat: '1150 - VAT Input',
  bank_charges: '6703 - Bank Charges',
  interest_income: '5201 - Dividends and Interest',
  salary_expense: '6601 - Salaries',
  employer_nssf_expense: '6606 - Contribution to Pension Fund (NSSF)',
  employer_housing_levy_expense: '6609 - Affordable Housing Levy (Employer)',
  net_payroll_payable: '3310 - Net Payroll Payable',
  paye_payable: '3302 - PAYE Payable',
  nssf_payable: '3303 - NSSF Payable',
  shif_payable: '3304 - NHIF / SHIF Payable',
  housing_levy_payable: '3305 - Affordable Housing Levy Payable',
  pension_payable: '3306 - Pension Payable',
  other_payroll_deductions: '3311 - Other Payroll Deductions Payable',
  employee_advances: '1931 - Employee Salary Advances',
}
