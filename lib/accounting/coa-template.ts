...
export function buildZeroBalanceCoaTemplate(): CoaTemplateAccount[] {
  ...
  a.push(
    ...
    { code: '1810', name: 'Employee Salary Advances', type: 'asset', group: 'Employee Receivables', subGroup: 'Salary Advances', balance: 0 },
    ...
    { code: '3110', name: 'Net Payroll Payable', type: 'liability', group: 'Payroll Liabilities', subGroup: 'Employees', balance: 0 },
    ...
    { code: '3305', name: 'PAYE Payable', type: 'liability', group: 'Statutory Liabilities', subGroup: 'Payroll', balance: 0 },
    { code: '3306', name: 'NSSF Payable', type: 'liability', group: 'Statutory Liabilities', subGroup: 'Payroll', balance: 0 },
    { code: '3307', name: 'SHIF Payable', type: 'liability', group: 'Statutory Liabilities', subGroup: 'Payroll', balance: 0 },
    { code: '3308', name: 'Affordable Housing Levy Payable', type: 'liability', group: 'Statutory Liabilities', subGroup: 'Payroll', balance: 0 },
    { code: '3309', name: 'Pension Payable', type: 'liability', group: 'Statutory Liabilities', subGroup: 'Payroll', balance: 0 },
    ...
    { code: '5002', name: 'Parts & Accessories', type: 'revenue', group: 'Revenue - Products', subGroup: 'Product', balance: 0 },
    { code: '5003', name: 'Services & Software', type: 'revenue', group: 'Revenue - Services', subGroup: 'Services', balance: 0 },
    ...
    { code: '6102', name: 'Services Purchases', type: 'expense', group: 'Local Purchases', subGroup: 'Local Purchases', balance: 0, notes: 'Cost account for service-kind products' },
    ...
    { code: '6400', name: 'Transport & Fuel', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6405', name: 'Office Supplies', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6410', name: 'Printing & Stationery', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6415', name: 'Utilities', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0, notes: 'Water / electricity and other utilities' },
    { code: '6420', name: 'Courier & Delivery', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6430', name: 'Meals & Entertainment', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6440', name: 'Software & Subscriptions', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6450', name: 'Maintenance & Repairs', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6495', name: 'Cash Over/Short', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6499', name: 'Other Operating Expenses', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6515', name: 'Loss on Disposal of Assets', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6517', name: 'Depreciation and Amortization', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0 },
    { code: '6521', name: 'Expensed Assets', type: 'expense', group: 'Operating Expenses', subGroup: 'Operating and Administrative', balance: 0, notes: 'Equipment/hardware purchases expensed rather than capitalized' },
    { code: '6705', name: 'Realized and Unrealized Exchange Loss', type: 'expense', group: 'Financial Expenses', subGroup: 'Financial Expenses', balance: 0 },
