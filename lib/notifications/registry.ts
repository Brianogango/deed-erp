...
export const NOTIFICATION_POLICIES: Record<string, NotificationPolicy> = {
  ...
  'hr.leave.approval_required': POLICY(['in_app', 'push', 'email', 'sms'], 'attention', { recipientRoles: ['director', 'admin_officer'], requiresAcknowledgement: true, escalationMinutes: 240 }),
  ...
  'hr.salary_advance.approval_required': POLICY(['in_app', 'push', 'email', 'sms'], 'attention', { recipientRoles: ['director', 'finance_officer'], requiresAcknowledgement: true, escalationMinutes: 240 }),
  ...
  'hr.payroll.approval_required': POLICY(['in_app', 'push', 'email', 'sms'], 'critical', { recipientRoles: ['director', 'finance_officer'], requiresAcknowledgement: true, escalationMinutes: 120, mandatory: true }),
